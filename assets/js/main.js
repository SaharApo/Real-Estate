...
function scrollUp(){
    ...
    // when the scroll is higher then 350 viewport height, add the show-scroll class to the a tag with the scroll- tag
...
sr.reveal('.home__description, .footer__info, .footer__container', {delay: 500})
